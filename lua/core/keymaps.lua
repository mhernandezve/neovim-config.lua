...
keymap.set('n', '<leader>fw', function() fzflua_builtin.grep_cword({ fzf_opts = {['--layout'] = 'reverse-list'} }) end, {desc = "Search cword"})
keymap.set('n', '<leader>fW', function() fzflua_builtin.grep_cWORD({ fzf_opts = {['--layout'] = 'reverse-list'} }) end, {desc = "Search cWORD"})
keymap.set('n', '<leader>fL', function() fzflua_builtin.grep_last({ fzf_opts = {['--layout'] = 'reverse-list'} }) end, {desc = "Grep Last"})
keymap.set('n', '<leader>fl', function() fzflua_builtin.live_grep({ fzf_opts = {['--layout'] = 'reverse-list'} }) end, {desc = "Live Grep"})
keymap.set('n', '<leader>fb', function() fzflua_builtin.buffers({ fzf_opts = {['--layout'] = 'reverse-list'} }) end, {desc = "Find Buffers"})
...
keymap.set("n", '<leader>d?', function() local widgets = require "dap.ui.widgets"; widgets.centered_float(widgets.scopes) end, {desc = "Widgets"})
...
keymap.set("n", '<leader>de', function() require('telescope.builtin').diagnostics({default_text=":E:"}) end, {desc = "Diagnostics"})
